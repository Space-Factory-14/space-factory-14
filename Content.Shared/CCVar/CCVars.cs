...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<string>
            GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "Shipwrecked", CVar.ARCHIVE);
        ...
        /// </summary>
        public static readonly CVarDef<string>
            GameMapPool = CVarDef.Create("game.map_pool", "PlanetMapPool", CVar.SERVERONLY);
        ...
        public static readonly CVarDef<string> TipsDataset =
            CVarDef.Create("tips.dataset", "SF_Tips");
